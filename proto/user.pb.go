...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x05users\x18\x01 \x03(\v2\x12.user.UserResponseR\x05users2\xe4\x01\n" +
	"\vUserService\x129\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x12.user.UserResponse\x123\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x12.user.UserResponse\x121\n" +
	"\tListUsers\x12\v.user.Empty\x1a\x17.user.ListUsersResponse\x122\n" +
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\v.user.EmptyB-Z+github.com/yourname/grpc-user-service/protob\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	4, // 0: user.ListUsersResponse.users:type_name -> user.UserResponse
